...
{% hint style="success" %}
We heard your feedback and combined 8.SET and 8.SET Custom into one query that already created useable product sets. :tada:Your feedback is always welcome and helpful! :heart:
{% endhint %}

...
```
{
    ...
    "errors": [
        ...
        "maxAlternatives should be a number between 0 and 10, current value is \"101\"",
        "... more request validation messages here"
    ]
}
```
{% endapi-method-response-example %}
...
{% api-method-response-example-description %}
Aktuell gibt es ein Limit von 1 Request / Sekunde
{% endapi-method-response-example-description %}
...
{% hint style="info" %}
Aktuell gibt es ein Limit von 1 Request pro Sekunde für API Anfragen.
{% endhint %}
...
curl -v -H \
    ...
    "https://api.8select.io/recommendations/product-sets?searchType=sku&searchValue=<SKU-aus-dem-Shop>&limit=1&maxAlternatives=10"
```

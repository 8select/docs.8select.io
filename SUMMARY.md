...
* [Events](api-tracking/events/README.md)
  * [view](api-tracking/events/view/README.md)
    * [How to evaluate if view event can be sent](api-tracking/events/view/how-to-evaluate-if-view-event-can-be-sent.md)
    * [User views 8.SET content](api-tracking/events/view/user-views-8.set-compose-content.md)
  * [interact](api-tracking/events/interact/README.md)
    * [User clicks on a product within 8.SET content](api-tracking/events/interact/user-clicks-on-a-product-within-8.set-compose-content.md)

...
{% api-method method="get" host="https://shopware.demo.8select.io/cse-api/products" path="" %}
{% api-method-summary %}
  ...
  "data": [
    {
      ...
      "parentId": "21",
      "sku": "SW10005.2",
      "url": "http://shopware-5-2-17-php7.staging.8select.io/hoehenluft-abenteuer/ausruestung/zubehoer/stoecke/5/hot-shot-s?number=SW10005.2",
      "images": [
      ...
      "parentArticle.ordernumber": {
        "label": "Artikelnummer Hauptartikel",
        "value": "SW10005"
      },
      "s_articles.name": {
...
```javascript
{
  "id": String // Identifikator der Produktvariante
  "parentId": String // Identifikator vom Elternprodukt der Variante
  "sku": String // Stock Keeping Unit der Produktvariante
  "url" String // Deeplink in den Shop die zur Artikeldetailseite führt
}
```
{% endcode-tabs-item %}
{% endcode-tabs %}
...
```bash
curl 'https://shopware.demo.8select.io/cse-api/products?limit=1&offset=18&fields[]=url' \
  ...
  "data": [
    {
      ...
      "parentId": "21",
      "sku": "SW10005.3",
      "url": "https://shopware.demo.8select.io/hoehenluft-abenteuer/ausruestung/zubehoer/stoecke/5/hot-shot-s?number=SW10005.3"
    }
  ]
}
```
